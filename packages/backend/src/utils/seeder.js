...
const getFakeHomeTown = () => {
  const cities = [
    'Anderson', 'Boiling Springs', 'Campobello', 'Chesnee', 'Clemson', 'Duncan', 'Enoree', 'Gaffney',
    'Greer', 'Greenville', 'Inman', 'Landrum', 'Laurens', 'Lyman', 'Moore', 'Pauline', 'Pendleton', 'Reidville',
