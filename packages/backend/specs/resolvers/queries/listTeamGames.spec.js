...
describe('Resolvers - Queries', () => {
  ...
  const data = [
    { Id: params.teamId, Metadata: 'Game-1', GameDay: 'Jan-17-2022', WinLoss: 'Win' },
    { Id: params.teamId, Metadata: 'Game-2', GameDay: 'Jan-24-2022', WinLoss: 'Loss' },
    { Id: params.teamId, Metadata: 'Game-3', GameDay: 'Jan-31-2022', WinLoss: 'Win' },
  ];
  const queryByTeamSpy = jest.spyOn(Game, 'queryByTeam').mockResolvedValue(data);
