...
describe('Resolvers - Queries', () => {
  ...
  const data = [
    { teamId: 'test-team-3', playerId: 'Player-1', playerName: 'Jane Doe', position: 'S' },
    { teamId: 'test-team-3', playerId: 'Player-2', playerName: 'Jack Doe', position: 'LW' },
    { teamId: 'test-team-3', playerId: 'Player-3', playerName: 'John Doe', position: 'G' },
    { teamId: 'test-team-3', playerId: 'Player-4', playerName: 'Snow Doe', position: 'M' },
    { teamId: 'test-team-3', playerId: 'Player-5', playerName: 'Fro\' Doe', position: 'RB' },


  ];
  const queryByTeamSpy = jest.spyOn(Player, 'queryByTeam').mockResolvedValue(data);
