...
const players = teams.flatMap((team) => [
  ...Array(forwardsCount)
    .fill()
    .map(() => createFakePlayer({ team, position: 'F' })),
  ...Array(midfieldersCount)
    .fill()
    .map(() => createFakePlayer({ team, position: 'M' })),
  ...Array(defendersCount)
    .fill()
    .map(() => createFakePlayer({ team, position: 'D' })),
  ...Array(goaliesCount)
    .fill()
    .map(() => createFakePlayer({ team, position: 'G' })),
]);
...
const games = [
  {
    teamId: 'boysU9',
    gameId: 'Game-boysU9-2021-01',
    gameDay: 'April-17-2021',
    winLoss: 'Win',
  },
  {
    teamId: 'boysU11',
    gameId: 'Game-boysU11-2021-01',
    gameDay: 'April-17-2021',
    winLoss: 'Loss',
  },
  {
    teamId: 'boysU13',
    gameId: 'Game-boysU13-2021-01',
    gameDay: 'April-17-2021',
    winLoss: 'Loss',
  },
  {
    teamId: 'boysU15',
    gameId: 'Game-boysU15-21-01',
    gameDay: 'April-17-2021',
    winLoss: 'Win',
  },
  {
    teamId: 'girlsU9',
    gameId: 'Game-girlsU9-2021-01',
    gameDay: 'April-17-2021',
    winLoss: 'Loss',
  },
  {
    teamId: 'girlsU11',
    gameId: 'Game-girlsU11-2021-01',
    gameDay: 'April-17-2021',
    winLoss: 'Win',
  },
  {
    teamId: 'girlsU13',
    gameId: 'Game-girlsU13-2021-01',
    gameDay: 'April-17-2021',
    winLoss: 'Win',
  },
  {
    teamId: 'girlsU15',
    gameId: 'Game-girlsU15-21-01',
    gameDay: 'April-17-2021',
    winLoss: 'Loss',
  },
];
...
const seedDatabase = async () => {
  try {
    ...
    const createTeamPromises = teams.map((params) =>
      mutations.createTeam(null, { input: { ...params } })
    );
    const createPlayerPromises = players.map((params) =>
      mutations.createPlayer(null, { input: { ...params } })
    );
    const createGamePromises = games.map((params) =>
      mutations.createGame(null, { input: { ...params } })
    );
    ...
    console.error(
      `DynamoDB seeding of the database table ${soccerTableName} failed! - ${ex.message}`
    );
  }
};
